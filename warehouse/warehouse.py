...
def runGames(layout, pacman, ghosts, display, numGames, record, numTraining=0, numGhostTraining=0, withoutShield=0, distCrossings=0,
    ...
    file_name_scores = "outputs/" + "scores_" + str(layout.name) + "_b" + str(distCrossings) + "_w" + str(withoutShield) + "_n" + str(numGames) + "_x" + str(numTraining) + "_y" + str(numGhostTraining) + ".txt"
    file_name_wins = "outputs/" + "wins_" + str(layout.name) + "_b" + str(distCrossings) + "_w" + str(withoutShield) + "_n" + str(numGames) + "_x" + str(numTraining) + "_y" + str(numGhostTraining) + ".txt"
