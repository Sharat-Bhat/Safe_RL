...
class WaterTank:
    def __init__(self, water_capacity=100, init_level=50, inflow = (1, 2), outflow = (0, 1)):
        ...
        self.water_level_states = list(range(0, self.water_capacity+1))
        self.current_state = init_level
        self.inflow = inflow
        self.outflow = outflow
        self.failed = False
        self.actions = [0] + range(inflow[0], inflow[1]+1)
        self.states = range(water_capacity+1)
...
class Shield:
    def __init__(self, switch_time_interval=3):
        ...
        self.states = range(2*switch_time_interval)
        self.failed = False
...
class WaterTankController():
    def __init__(self, WaterTank, Shield):
        ...
        self.actions = WaterTank.actions
